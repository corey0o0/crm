...
const AVAILABLE_PERMISSIONS = [
  ...
  { key: 'outbound_scan', label: '출고 검수 (판매)' },
  { key: 'sales_entry', label: '단순 판매 등록' },
  { key: 'manual_sales', label: '수기 판매관리' },
  { key: 'sales_history', label: '판매 현황' },
  ...
  { key: 'inventory_history', label: '입출고 내역' },
  { key: 'inventory_status', label: '재고 현황' },
  { key: 'inventory_scan', label: '출고 검수 (재고조사)' },
  { key: 'inventory_boxes', label: '박스 상태 관리' },
  { key: 'inventory_locations', label: '창고/대리점 관리' },
  ...
  { key: 'pending_orders', label: '주문 대기' },
