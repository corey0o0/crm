...
[출력 형식] 한국어, 친절하고 간결하게, 3문장 이내`,
      faqs: [
        ...
        { label: '사이즈호환', keywords: ['사이즈', '크기', '호환', '규격'], answer: '자전거 사이즈 및 부품 호환성은 제품마다 다를 수 있습니다. 모델명과 함께 고객센터로 문의주시면 상세히 안내해 드립니다.' },
        { label: '재고품절', keywords: ['재고', '품절', '입고'], answer: '재고 현황은 상품 페이지에서 실시간 확인이 가능합니다. 품절 상품 입고 일정은 고객센터로 문의해 주세요.' },
        // ── 모델 제원 ──
